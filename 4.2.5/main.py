...
class Node:
    def __init__(
        self, letter=None, left_child=None, right_child=None, freq=None, code=""
    ):
        self.letter = letter
    ...
    def __str__(self):
        return "freq={} lc_freq_id={} rc_freq_id={}".format(
            self.freq, id(self.left_child), id(self.right_child)
        )
